...
use Pinturus\Entity\User;
use Pinturus\Form\Type\UserType;
use Pinturus\Form\Type\UpdatePasswordType;
use Pinturus\Form\Type\ForgottenPasswordType;
use Pinturus\Form\Type\LoginType;
...
class UserController implements ControllerProviderInterface
{
	...
	public function votesUserDatatablesAction(Request $request, Application $app, $username)
	{
		...
		$entities = $app['repository.paintingvote']->findVoteByUser($iDisplayStart, $iDisplayLength, $sortByColumn, $sortDirColumn, $sSearch, $username);
		$iTotal = $app['repository.paintingvote']->findVoteByUser($iDisplayStart, $iDisplayLength, $sortByColumn, $sortDirColumn, $sSearch, $username, true);
